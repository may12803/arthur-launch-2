...
ARG NEXT_PUBLIC_SUPABASE_LOVELEEDAY_URL
ARG NEXT_PUBLIC_SUPABASE_LOVELEEDAY_ANON_KEY
ENV NEXT_PUBLIC_SUPABASE_LOVELEEDAY_URL=$NEXT_PUBLIC_SUPABASE_LOVELEEDAY_URL
ENV NEXT_PUBLIC_SUPABASE_LOVELEEDAY_ANON_KEY=$NEXT_PUBLIC_SUPABASE_LOVELEEDAY_ANON_KEY
