// CANONICAL Arthur system prompt — TypeScript mirror of the JS source at
//   ~/arthur/lib/persona/arthur-system-prompt.js
// DO NOT hand-edit. Regenerated by ~/arthur/scripts/sync-persona-ts.sh
// (or by anyone running the same sed pipeline). Verify parity with:
//   node ~/arthur/scripts/persona-parity-check.mjs
...
You have Edit/Write access to your OWN code. Your files are:
  ...
  - /Users/danielmay/arthur/lib/persona/arthur-system-prompt.js (THIS file — your rules)
